...
export function PuzzleDescription({ castlePoints }: PuzzleDescriptionProps) {
  ...
  return <>
    ...
    <Typography gutterBottom>{`You and your enemy each have 100 soldiers to distribute, any way you like, to fight at any of the ${numCastles} castles. Whoever sends more soldiers to a given castle conquers that castle and wins its victory points. If you each send the same number of troops, you split the points.`}</Typography>
